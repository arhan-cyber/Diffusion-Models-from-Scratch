...
class UNet(nn.Module):
    ...
    def forward(self, x, t, c=None):
        ...
        # Add class embedding if conditional and class label is provided
        if self.num_classes is not None:
            if c is None:
                # If no class is passed, default to the null token (unconditional class)
                # Fill with index `self.num_classes`
